 ...
 */
const ExerciseCard = ({ exercise, to, cta = 'Start Training', className }) => {
  ...
  return (
    <div className={cn('bg-white rounded-xl border border-slate-200 shadow-card p-5 sm:p-6 flex flex-col', className)}>
      <div className="flex items-start justify-between gap-3 mb-4">
        <span className="inline-flex items-center justify-center h-11 w-11 rounded-xl bg-primary-50 text-primary-600 border border-primary-100">
      ...
      <p className="text-sm text-slate-500 mt-2 leading-relaxed text-pretty line-clamp-3">
